...
describe User do
  ...
  it "should reject duplicate email addresses" do
    # add a user with given email adderss first
    User.create(@attr)
    
    # add duplicate user
    user_with_duplicate_email = User.new(@attr.merge(:name => "new name"))
  ...
  describe "password encryption" do
    ...
    it "should have an encrypted passwrod attribute" do
    ...
    describe "authenticate method" do
      ...
      it "should return nil for email address with no user" do
        wrong_email_user = User.authenticate("wrongemail@foo.com", @attr[:password])
